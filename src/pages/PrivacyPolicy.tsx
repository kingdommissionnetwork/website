  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] dark:bg-[#071324] text-[#0c1b33] dark:text-white pt-16 md:pt-[92px] lg:pt-[108px] pb-24">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#eef4fb] via-[#f8fafc] to-[#fdf8ee] dark:from-[#0c1b33] dark:via-[#071324] dark:to-[#1a1107] text-[#0c1b33] dark:text-white py-16 lg:py-20 px-4 sm:px-6 transition-colors duration-300">
        ...
        <div className="container-main mx-auto max-w-4xl text-center space-y-4 relative z-10">
          ...
          <h1 className="font-brand text-3xl sm:text-5xl font-bold tracking-tight text-[#0c1b33] dark:text-white">
            Privacy <span className="bg-gradient-to-r from-[#996515] via-[#d4af37] to-[#8b5e3c] dark:from-[#d4af37] dark:via-[#f5e6b3] dark:to-[#c5961d] bg-clip-text text-transparent">Policy</span>
          </h1>
      ...
      <section className="container-main mx-auto max-w-4xl px-4 sm:px-6 py-12">
        <div className="bg-white dark:bg-[#0a1628] rounded-3xl p-6 sm:p-12 shadow-md border border-black/5 dark:border-white/8 space-y-10">
          {/* Section 1 */}
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-[#d4af37]/15 flex items-center justify-center text-[#996515] dark:text-[#f6c873]">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm sm:text-base text-black/75 dark:text-slate-300">
          ...
          <div className="space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-[#FAF7F2] dark:bg-white/5 border border-black/5 dark:border-white/10">
                <CheckCircle className="w-5 h-5 text-emerald-600 dark:text-emerald-400 mb-2" />
                <h4 className="font-bold text-sm text-[#0c1b33] dark:text-white">No Commercial Sale</h4>
                <p className="text-xs text-black/65 dark:text-slate-400 mt-1">We will never sell, rent, or trade your personal data or email to commercial marketers or third parties.</p>
              </div>
              <div className="p-4 rounded-2xl bg-[#FAF7F2] dark:bg-white/5 border border-black/5 dark:border-white/10">
                <CheckCircle className="w-5 h-5 text-emerald-600 dark:text-emerald-400 mb-2" />
                <h4 className="font-bold text-sm text-[#0c1b33] dark:text-white">Encrypted Transmission</h4>
                <p className="text-xs text-black/65 dark:text-slate-400 mt-1">All communications are encrypted using high-grade SSL/TLS protocols with enterprise-level security firewalls.</p>
              </div>
            </div>
          </div>
