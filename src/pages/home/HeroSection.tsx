    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#071324] via-[#0c1b33] to-[#1a1107] pt-16 sm:pt-20 md:pt-[92px] lg:pt-[108px] pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="container-main mx-auto relative z-10 max-w-7xl w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          {/* Bishop Showcase: Displayed FIRST on mobile for instant authority and identification, right on desktop */}
          <div className="lg:col-span-5 flex justify-center relative order-1 lg:order-2">
            <ScrollReveal delay={100}>
              <div className="relative w-full max-w-[210px] xs:max-w-[235px] sm:max-w-[320px] md:max-w-[400px] lg:max-w-[470px] mx-auto flex flex-col items-center">
                {/* Background Golden Radiance Aura */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#d4af37]/25 via-[#f97316]/15 to-transparent blur-3xl transform scale-95 pointer-events-none" />
                ...
                <div className="relative z-10 flex justify-center">
                  <img
                    ...
                    className="w-full h-auto max-h-[195px] xs:max-h-[220px] sm:max-h-[340px] md:max-h-[480px] lg:max-h-[600px] object-contain drop-shadow-[0_12px_32px_rgba(0,0,0,0.65)]"
                    width="470"
                    height="595"
                    loading="eager"
                  />
                ...
                {/* Leadership Identification Badge */}
                <div className="relative -mt-3.5 sm:mt-0 sm:absolute sm:bottom-2 sm:left-1/2 sm:-translate-x-1/2 z-20 w-auto max-w-[94%] sm:max-w-none px-3.5 py-1.5 sm:px-5 sm:py-3 rounded-2xl bg-[#071324]/95 border border-[#d4af37]/60 shadow-[0_8px_32px_rgba(0,0,0,0.55)] backdrop-blur-md text-center sm:text-left">
                  <div className="flex items-center justify-center sm:justify-start gap-1.5 mb-0.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                    <span className="font-outfit text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-[#d4af37]">
                      Founder &amp; Spiritual Overseer
                    </span>
                  </div>
                  <h2 className="font-brand text-xs sm:text-base font-bold text-white leading-tight">
                    Bishop Dr. George Githinji
                  </h2>
                  <p className="font-outfit text-[9px] sm:text-[10px] text-white/70">
          ...
          {/* Main Content & Actions: Below Bishop on mobile, Left on desktop */}
          <div className="lg:col-span-7 text-center lg:text-left space-y-3.5 sm:space-y-5 md:space-y-6 order-2 lg:order-1">
            <ScrollReveal delay={150}>
              <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1 sm:px-4 sm:py-1.5 rounded-full bg-white/[0.08] border border-[#d4af37]/40 text-[#fbf5b7] text-[10px] sm:text-xs font-semibold shadow-inner backdrop-blur-md">
            ...
            <ScrollReveal delay={200}>
              <h1 className="font-brand text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-[58px] xl:text-[62px] font-bold text-white leading-[1.12] tracking-tight">
            ...
            <ScrollReveal delay={250}>
              <p className="font-outfit text-xs xs:text-sm sm:text-base md:text-lg text-white/80 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal">
            ...
            <ScrollReveal delay={300}>
              <div className="flex flex-row flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-3 pt-0.5 sm:pt-1">
                <Link
                  to="/prayer-wall"
                  className="flex-1 sm:flex-initial min-w-[125px] px-4 sm:px-6 py-2.5 sm:py-3 rounded-full bg-gradient-to-r from-[#d4af37] via-[#f3e5ab] to-[#c5961d] text-[#0c1b33] font-bold text-xs sm:text-sm hover:shadow-[0_0_25px_rgba(212,175,55,0.5)] transition-all flex items-center justify-center gap-1.5 active:scale-95 shadow-md whitespace-nowrap"
                >
                  <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4 fill-current text-[#0c1b33]" />
                  <span>24/7 Prayer Wall</span>
                </Link>
                <Link
                  to="/sermons"
                  className="flex-1 sm:flex-initial min-w-[125px] px-4 sm:px-6 py-2.5 sm:py-3 rounded-full bg-white/[0.08] hover:bg-white/[0.15] border border-white/25 text-white font-semibold text-xs sm:text-sm transition-all flex items-center justify-center gap-1.5 backdrop-blur-sm active:scale-95 whitespace-nowrap"
                >
                  <Play className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#d4af37]" />
                  <span>Watch Sermons</span>
                </Link>
                <Link
                  to="/subscribe"
                  className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-[#d4af37]/15 hover:bg-[#d4af37]/25 border border-[#d4af37]/50 text-[#fbf5b7] font-semibold text-xs sm:text-sm transition-all flex items-center justify-center gap-1.5 backdrop-blur-sm active:scale-95 shadow-[0_0_15px_rgba(212,175,55,0.15)] whitespace-nowrap"
                >
            ...
            <ScrollReveal delay={350}>
              <div className="pt-3 sm:pt-5 border-t border-white/10 max-w-xl mx-auto lg:mx-0">
                <p className="font-brand text-xs sm:text-base italic text-[#f3e5ab]">
                  &ldquo;For where two or three gather in my name, there am I with them.&rdquo;
                </p>
                <p className="font-outfit text-[9px] sm:text-xs text-[#d4af37] font-semibold uppercase tracking-widest mt-0.5 sm:mt-1">
                  — Matthew 18:20
                </p>
              </div>
            </ScrollReveal>
